...
class IngresoPqrsRequest extends Request {
	...
	public function rules()
	{
		...
		'afectado'						=>		'max:100',
		'celuar_afectado'				=>		'numeric',
		'correo_afectado'				=>		'email',
		'ruta_id'						=>		'exists:sw_rutas,rut_id',
		'vehic_id'						=>		'exists:sw_vehiculo,veh_id',
		'sitp_id'						=>		'exists:sw_vehiculo,veh_id',
		'patio_id'						=>		'exists:sw_patio,pto_id',
		'area_id'						=>		'exists:sw_areas,area_id',
