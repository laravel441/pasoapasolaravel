...
class EditEmpRequest extends Request {
    ...
    public function rules()
    {
        ...
        return [
            ...
            'emp_an8' => 'required|max:255|unique:sw_empleados,emp_an8,'. $this->route->getParameter('emps'),
            'emp_area_id'=>'',
            'emp_cod_tm'=>'required|max:255|unique:sw_empleados,emp_cod_tm',
            'emp_identificacion'=>'required|max:255|unique:sw_empleados,emp_identificacion,'. $this->route->getParameter('emps'),
            ...
            'emp_correo'=>'required|email|max:255|unique:sw_empleados,emp_correo,'. $this->route->getParameter('emps'),
